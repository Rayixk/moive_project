...
insert into comment(movie_id,user_id,content,addtime) values(1,3,"经典",now());
insert into comment(movie_id,user_id,content,addtime) values(1,4,"给力",now());
insert into comment(movie_id,user_id,content,addtime) values(1,1,"难看",now());
insert into comment(movie_id,user_id,content,addtime) values(1,2,"无聊",now());
insert into comment(movie_id,user_id,content,addtime) values(1,3,"乏味",now());
insert into comment(movie_id,user_id,content,addtime) values(1,4,"无感",now());

ALTER TABLE comment auto_increment=1;

/*收藏*/
insert into moviecol(movie_id,user_id,addtime) values(1,1,now());
insert into moviecol(movie_id,user_id,addtime) values(1,2,now());
insert into moviecol(movie_id,user_id,addtime) values(1,3,now());
insert into moviecol(movie_id,user_id,addtime) values(1,4,now());
insert into moviecol(movie_id,user_id,addtime) values(1,1,now());
insert into moviecol(movie_id,user_id,addtime) values(1,2,now());
insert into moviecol(movie_id,user_id,addtime) values(1,3,now());
insert into moviecol(movie_id,user_id,addtime) values(1,4,now());
